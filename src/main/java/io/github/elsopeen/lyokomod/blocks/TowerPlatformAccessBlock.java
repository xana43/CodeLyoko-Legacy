...
public class TowerPlatformAccessBlock extends HorizontalBlock {
     ...
     */
    public TowerPlatformAccessBlock(Properties builder) {
        super(builder);
     ...
     * @param state blockState on block update
     * @param reader world in which the block is
    ...
    @Nonnull
    @Override
    public VoxelShape getCollisionShape(BlockState state, @Nonnull IBlockReader worldIn,
