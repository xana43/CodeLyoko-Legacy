	 ...
	 if (!worldIn.isRemote)
     {
                 ...
                 for (int i = 0; i < 90; ++i)
                 {
                    ...
                    // BlockState iblockstate = worldIn.getBlockState(blockpos.up());
                     ...
                     if (iblockstate1.getBlock() == Blocks.COARSE_DIRT || iblockstate1.getBlock() == Blocks.GRASS_PATH|| iblockstate1.getBlock() == Blocks.DIRT ||    iblockstate1.getBlock() == ModBlocks.FOREST_GRASS.get() || iblockstate1.getBlock() == ModBlocks.BANQUISE_ICE.get())
                     {
