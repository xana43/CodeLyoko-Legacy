...
public class LyokoDesertBiomeProvider extends BiomeProvider {

    private static final Set<Biome> biomeList = ImmutableSet.of(ModBiomes.DESERT.get());
    private Random rand;
    private final double biomeSize = 16.0D;
    private VoronoiGenerator biomeNoise;

    public LyokoDesertBiomeProvider(LyokoBiomeProviderSettings settings) {
        super(biomeList);
        rand = new Random();
