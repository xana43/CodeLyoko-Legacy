...
public class ModEntities {
	...
	public static final DeferredRegister<EntityType<?>> Entities = new DeferredRegister<>(ForgeRegistries.ENTITIES, LyokoMod.MOD_ID);
	...
	.build(new ResourceLocation(LyokoMod.MOD_ID,"blok").toString()));
