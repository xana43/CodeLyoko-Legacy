...
//for music discs
public static final RegistryObject<Item> LYOKO_DISC = ModItems.ITEMS.register("lyokoDisc", () -> new LyokoRecords(10, LAZY_THEME.get(), new Item.Properties().group(ModItemGroups.CODE_LYOKO_ITEMS).maxStackSize(1).rarity(Rarity.RARE)));
	 //for sound events
