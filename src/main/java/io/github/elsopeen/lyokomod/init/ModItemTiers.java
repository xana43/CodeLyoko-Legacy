...
public enum ModItemTiers implements IItemTier {
	...
	LYOKOFELINE(4, 2000, 900, 6, 90, () -> {
		return Ingredient.fromItems(ModItems.URANIUM_SILICATE.get());
	}),
	...
	private ModItemTiers(int harvest, int MaxUses, float efficiency, float attackdamage, int enchantability, Supplier<Ingredient> anvilmat)
	{
