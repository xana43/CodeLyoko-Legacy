...
public class ColoredParticle extends Particle {
    ...
    public ColoredParticle(ClientLevel world, double x, double y, double z, double xspeed, double yspeed, double zspeed, ColoredParticleData data) {
        ...
        this.scale(0.1f * (Random.nextFloat() * 0.2f + 2));
    ...
    public static class Factory implements ParticleProvider<ColoredParticleData> {
        ...
        @Nullable
        @Override
        public Particle makeParticle(@Nonnull ColoredParticleData typeIn, @Nonnull Level worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class ColoredParticleData implements ParticleOptions {
        ...
        public static final ParticleOptions.Deserializer<ColoredParticleData> DESERIALIZE = new ParticleOptions().Deserializer<ColoredParticleData>() {
