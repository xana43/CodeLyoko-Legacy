...
public class ChunkGeneratorLyoko5 implements IChunkGenerator
{
    ...
    protected Biome biome = ModBiome.SECTOR_5;
    protected IBlockState baseBlock = Modblocks.SECTOR_5.getDefaultState();
    protected IBlockState oceanBlock = Blocks.AIR.getDefaultState();
    ...
    public ChunkGeneratorLyoko5(World worldIn)
    {
        // DEBUG
