...
public class ModItems {
    ...
    public static final RegistryObject<WrittenBookItem> STORY_BOOK = ITEMS.register("story_book", () -> new StoryBook(new Item.Properties().tab(CodeLyokoMain.LYOKO_ITEMS).stacksTo(1)));
    ...
    public static final RegistryObject<ArmorItem> ODD_CHESTPLATE = ITEMS.register("odd_chestplate", () -> new ArmorFeline(LyokoArmorMaterial.FELNINE, EquipmentSlot.CHEST, new Item.Properties().tab(CodeLyokoMain.LYOKO_ARMOR)));
    public static final RegistryObject<ArmorItem> ODD_LEGGINGS = ITEMS.register("odd_leggings", () -> new ArmorFeline(LyokoArmorMaterial.FELNINE, EquipmentSlot.LEGS, new Item.Properties().tab(CodeLyokoMain.LYOKO_ARMOR)));
    public static final RegistryObject<ArmorItem> ODD_BOOTS = ITEMS.register("odd_boots", () -> new ArmorFeline(LyokoArmorMaterial.FELNINE, EquipmentSlot.FEET, new Item.Properties().tab(CodeLyokoMain.LYOKO_ARMOR)));
    ...
    //for buckets
    public static final RegistryObject<BucketItem> LIQUID_HELIUM_BUCKET = ITEMS.register("liquid_helium_bucket", () -> new BucketItem(ModFluids.STILL_LIQUID_HELIUM, new Item.Properties().tab(CodeLyokoMain.LYOKO_ITEMS).stacksTo(1)));
