...
public class ModItems {
    ...
    public static final RegistryObject<Item> COMPUTER_ARM_APU_CORE = ITEMS.register("computer_arm_apu_core", () -> new ComputerItem(new Item.Properties().group(Base.LYOKO_ITEMS).rarity(Rarity.COMMON)));
    public static final RegistryObject<Item> COMPUTER_X86_APU_CORE = ITEMS.register("computer_x86_apu_core", () -> new ComputerItem(new Item.Properties().group(Base.LYOKO_ITEMS).rarity(Rarity.COMMON)));
    public static final RegistryObject<Item> COMPUTER_CISC_APU_CORE = ITEMS.register("computer_cisc_apu_core", () -> new ComputerItem(new Item.Properties().group(Base.LYOKO_ITEMS).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> COMPUTER_RISC_APU_CORE = ITEMS.register("computer_risc_apu_core", () -> new ComputerItem(new Item.Properties().group(Base.LYOKO_ITEMS).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> COMPUTER_ASIC_APU_CORE = ITEMS.register("computer_asic_apu_core", () -> new ComputerItem(new Item.Properties().group(Base.LYOKO_ITEMS).rarity(Rarity.EPIC)));
