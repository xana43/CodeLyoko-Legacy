...
public class ModSounds {
    ...
    public static Lazy<Music> LAZY_FOREST = RegisterThemeSounds("forest.json",CodeLyokoMain.CodeLyokoPrefix("forest.json"));
    public static Lazy<Music> LAZY_DESERT = Lazy.of(() -> new Music(new SoundEvent(CodeLyokoMain.CodeLyokoPrefix("sector5")),0,0,true));
   ...
   // public static final RegistryObject<SoundEvent> SECTOR5 = SOUNDS.register("sector5", () -> LAZY_SECTOR5.get().getEvent());
