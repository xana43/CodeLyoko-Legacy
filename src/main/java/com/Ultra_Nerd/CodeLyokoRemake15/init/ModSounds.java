...
public class ModSounds {
    ...
    //for music discs
    public static final RegistryObject<RecordItem> LYOKO_DISC = ModItems.ITEMS.register("lyokodisc", () -> new RecordItem((byte) 10, LAZY_THEME, new Item.Properties().tab(Base.LYOKO_ITEMS).stacksTo(1).rarity(Rarity.RARE)));
    //for sound events
    ...
    public static final RegistryObject<SoundEvent> DEVIRTUALIZATION = SOUNDS.register("devertualization", () -> new SoundEvent(new ResourceLocation(Base.MOD_ID,"player.devertualization")));
}
