...
public enum  LyokoArmorMaterial implements IArmorMaterial {
     ...
     WARRIOR(Base.MOD_ID + ":william",5 , new int[]{8,9,10,8}, 420 , ModSounds.LAZY_ARMOR.get(), 10F, () -> {
        return Ingredient.fromItems(ModItems.PETABYTE.get());
    }),
    BLANKHELM(Base.MOD_ID + ":blank",5 , new int[]{8,9,10,8}, 420 , SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 10F, () -> {
        return Ingredient.fromItems(ModItems.PETABYTE.get());
    });
