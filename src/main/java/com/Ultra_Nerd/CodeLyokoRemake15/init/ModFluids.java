...
public class ModFluids {
    ...
    public static final RegistryObject<FlowingFluidBlock> DIGITAL_LAVA_BLOCK = ModBlocks.BLOCKS.register("digital_lava_block", () -> new DigitalLavaBlock(DIGITAL_LAVA_STILL));
}
