...
public class ModFluids {
 ...
 //for fluids
    ...
    public static final ForgeFlowingFluid.Properties HELIUM_PROPERTIES = new ForgeFlowingFluid.Properties(() -> STILL_LIQUIDHELIUM.get(),() -> FLOWING_LIQUIDHELIUM.get(),
            FluidAttributes.builder(LIQUIDHELIUM_STILL_RL,LIQUIDHELIUM_FLOWING_RL).overlay(LIQUIDHELIUM_STILL_RL).density(9).temperature(0).viscosity(0).luminosity(1)).block(() -> ModFluids.LIQUIDHELIUM.get());
