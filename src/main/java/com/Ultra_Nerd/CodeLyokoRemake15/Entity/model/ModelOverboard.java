package com.Ultra_Nerd.CodeLyokoRemake15.Entity.model;// Made with Blockbench 4.2.1
...
public class ModelOverboard<T extends OverboardEntity> extends EntityModel<T> {
	...
	public ModelOverboard(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Mainbody = partdefinition.addOrReplaceChild("Mainbody", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -1.0F, -4.0F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.0F))
