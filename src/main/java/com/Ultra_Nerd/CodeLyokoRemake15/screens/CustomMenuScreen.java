...
/*
    ...
    private static final ResourceLocation MINECRAFT_TITLE_TEXTURES = new ResourceLocation(CodeLyokoMain.MOD_ID, "textures/gui/title_image.png");
   ...
   /* private Screen realmsNotificationsScreen;
    ...
    private boolean minceraftEasterEgg = (double)(new Random()).nextFloat() < 1.0E-4D;;
   ...
   /* private boolean areRealmsNotificationsEnabled() {
    ...
    private void createNormalMenuOptions(int p_96764_, int p_96765_) {
        ...
        Button.OnTooltip button$ontooltip = flag ? Button.NO_TOOLTIP : new Button.OnTooltip() {
            ...
            public void onTooltip(Button p_169458_, PoseStack p_169459_, int p_169460_, int p_169461_) {
                if (!p_169458_.active) {
                    //this.narrateTooltip(p_169459_,  Minecraft.getInstance().font.split(this.text, Math.max( / 2 - 43, 170)), p_169460_, p_169461_);
                }
    ...
    private void createDemoMenuOptions(int p_96773_, int p_96774_) {
        ...
        this.buttonResetDemo = this.addRenderableWidget(new Button(this.width / 2 - 100, p_96773_ + p_96774_ * 1, 200, 20, new TranslatableComponent("menu.resetdemo"), (p_211783_) -> {
            ...
            try {
                ...
                CodeLyokoMain.Log.warn("Failed to access demo world", (Throwable)ioexception);
            }
    ...
    private boolean checkDemoWorldPresence() {
        try {
            ...
            SystemToast.onWorldAccessFailure(this.minecraft, "Demo_World");
            CodeLyokoMain.Log.warn("Failed to read demo world data", (Throwable)ioexception);
            return false;
        }
    }
    ...
    public void render(PoseStack p_96739_, int p_96740_, int p_96741_, float p_96742_) {
        ...
        if ((l & -67108864) != 0) {
            ...
            RenderSystem.setShaderTexture(0, MINECRAFT_TITLE_EDITION);
    ...
    public boolean mouseClicked(double p_96735_, double p_96736_, int p_96737_) {
        if (super.mouseClicked(p_96735_, p_96736_, p_96737_)) {
            ...
            return this.areRealmsNotificationsEnabled() && this.realmsNotificationsScreen.mouseClicked(p_96735_, p_96736_, p_96737_);
        }
    }
    ...
    private void confirmDemo(boolean p_96778_) {
        if (p_96778_) {
            try {
                ...
                CodeLyokoMain.Log.warn("Failed to delete demo world", (Throwable)ioexception);
            }
        }
