...
public class CustomMenuScreen extends Screen {
    ...
    public static final RenderSkyboxCube PANORAMA_RESOURCES = new RenderSkyboxCube(new ResourceLocation(Base.MOD_ID, "textures/skies/mainmenupanorama/sector5sky.png"));
    ...
    private static final ResourceLocation MINECRAFT_TITLE_TEXTURES = new ResourceLocation(Base.MOD_ID, "textures/gui/title_image.png");
