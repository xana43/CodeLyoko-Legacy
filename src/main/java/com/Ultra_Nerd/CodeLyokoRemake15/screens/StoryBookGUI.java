...
public class StoryBookGUI extends BookViewScreen {
    ...
    @Override
    public void render(PoseStack post, int p_render_1_, int p_render_2_, float p_render_3_) {
        super.render(post,p_render_1_, p_render_2_, p_render_3_);
    ...
    private void Initall() {
        ...
        this.story.canWrite();
        this.story.setMessage(new TranslatableComponent("Entry 1: " + "\n" +
                "07/29/2020" + "\n" +
