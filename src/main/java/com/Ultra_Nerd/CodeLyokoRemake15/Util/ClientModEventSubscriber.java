...
public class ClientModEventSubscriber {
    ...
    public static void onFMLClientSetupEvent(final FMLClientSetupEvent event) {
        ...
        ScreenManager.registerFactory(ModContainerTypes.CONTAINER_ELECTRIC_INFUSING.get(), ElectricInfusingChamberScreen::new);
        ScreenManager.registerFactory(ModContainerTypes.TOWER_INTERFACE_CONTAINER.get(), TowerGUI::new);
        ScreenManager.registerFactory(ModContainerTypes.QUANTUM_CHIPLET_CONTAINER.get(), QuantumChipletScreen::new);
        ScreenManager.registerFactory(ModContainerTypes.ELECTROPLATING_CONTAINER.get(), ElectroplatingScreen::new);
        ScreenManager.registerFactory(ModContainerTypes.COMPUTER_CONTROL_PANEL_CONTAINER.get(),
