...
/*
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if(ID == Conf.INTERFACE) return new TowerContainer(player.inventory, (TowerInterfaceTileEntity)world.getTileEntity(new BlockPos(x, y, z)));
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if(ID == Conf.INTERFACE) return new TowerGUI((TowerInterfaceTileEntity)world.getTileEntity(new BlockPos(x, y, z)));
