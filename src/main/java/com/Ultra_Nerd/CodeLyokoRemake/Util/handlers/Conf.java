...
public class Conf {
	...
	public static void fil(File file)
	{
		...
		Dim6 = conf.getInt("Sector 5 ID", cat, Dim6, 2, 1000000000, "this is the dimension ID for secto5");
        ...
        Dim4 = conf.getInt("Digital Ocean ID", cat, Dim4, 6, 1000000000, "this is the dimension ID for the digital ocean");
