...
public class WorldGenTower implements IWorldGenerator 
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,IChunkProvider chunkProvider) 
	{
		...
		{
			generateStructure(TOWER, world, random, chunkX, chunkZ, 5, Modblocks.DIGITAL_BLOCK , LyokoFS.class);
		}
		else if(world.provider.getDimension() == Conf.Dim2)
		{
			generateStructure(TOWER, world, random, chunkX, chunkZ, 5, Modblocks.DIGITAL_ICE , LyokoICE.class);
		}
