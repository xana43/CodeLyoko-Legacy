...
import com.Ultra_Nerd.CodeLyokoRemake.Blocks.tileentity.MuliblockTest;
...
public class Multi extends blockBase {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		new MuliblockTest().Check(worldIn, playerIn);
		return true;
	}
