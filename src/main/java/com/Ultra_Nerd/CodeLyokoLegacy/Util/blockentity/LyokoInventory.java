...
public interface LyokoInventory extends Inventory {
    /**
     * Creates an inventory from the item list.
     */
    static LyokoInventory of(final DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     */
    static LyokoInventory ofSize(final int size) {
