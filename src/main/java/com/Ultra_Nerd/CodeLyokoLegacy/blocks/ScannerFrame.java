...
public final class ScannerFrame extends Block implements MultiBlockPartCallback {
    ...
    private static final VoxelShape shapeN = Stream.of(
            ...
            Block.createCuboidShape(-4.000000000000002, 0, 5.8518599999999985, -3.0000000000000018, 15.3, 11.851859999999999),
            ...
            Block.createCuboidShape(-3.0000000000000018, 0, 2.8518599999999985, -2.0000000000000018, 15.3, 5.8518599999999985),
            Block.createCuboidShape(18, 0, 2.8518599999999985, 19, 15.3, 5.8518599999999985),
            Block.createCuboidShape(-3.0000000000000018, 0, 11.851859999999999, -2.0000000000000018, 15.3, 14.851859999999999),
            Block.createCuboidShape(2, 1, 18.851860000000002, 3, 16.3, 19.851860000000002),
            ...
            Block.createCuboidShape(-2.0000000000000018, 0, 1.8518599999999985, -1.0000000000000018, 15.3, 2.8518599999999985),
            ...
            Block.createCuboidShape(-1.0000000000000018, 0, 0.8518599999999985, -1.7763568394002505e-15, 15.3, 1.8518599999999985),
            ...
            Block.createCuboidShape(-1.0000000000000018, 0, 15.851859999999999, -1.7763568394002505e-15, 15.3, 16.851860000000002),
            ...
            Block.createCuboidShape(-2.0000000000000018, 0, 14.851859999999999, -1.0000000000000018, 15.3, 15.851859999999999)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
    private static final VoxelShape shapeW = Stream.of(
            ...
            Block.createCuboidShape(2.4259299999999993, 0, -2.5740700000000007, 5.425929999999999, 15.3, -1.5740700000000007),
            Block.createCuboidShape(11.42593, 0, 18.42593, 14.42593, 15.3, 19.42593),
            Block.createCuboidShape(18.42593, 1, 13.42593, 19.42593, 16.3, 14.42593),
            Block.createCuboidShape(-2.5740700000000007, 0, 2.4259299999999993, -1.5740700000000007, 15.3, 5.425929999999999),
            ...
            Block.createCuboidShape(-1.5740700000000007, 0, 1.4259299999999993, -0.5740700000000007, 15.3, 2.4259299999999993),
            Block.createCuboidShape(17.42593, 0, 14.42593, 18.42593, 15.3, 15.42593),
            ...
            Block.createCuboidShape(-0.5740700000000007, 0, 0.42592999999999925, 0.42592999999999925, 15.3, 1.4259299999999993),
            Block.createCuboidShape(16.42593, 0, 15.42593, 17.42593, 15.3, 16.42593),
            ...
            Block.createCuboidShape(0.42592999999999925, 0, -0.5740700000000007, 1.4259299999999993, 15.3, 0.42592999999999925),
            Block.createCuboidShape(15.42593, 0, 16.42593, 16.42593, 15.3, 17.42593),
            ...
            Block.createCuboidShape(1.4259299999999993, 0, -1.5740700000000007, 2.4259299999999993, 15.3, -0.5740700000000007),
            Block.createCuboidShape(14.42593, 0, 17.42593, 15.42593, 15.3, 18.42593)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
    private static final VoxelShape shapeE = Stream.of(
            ...
            Block.createCuboidShape(1.5740700000000007, 0, -2.5740700000000025, 4.574070000000001, 15.3, -1.5740700000000025),
            Block.createCuboidShape(-3.425930000000003, 1, 2.4259299999999993, -2.425930000000003, 16.3, 3.4259299999999993),
            Block.createCuboidShape(17.57407, 0, 11.42593, 18.57407, 15.3, 14.42593),
            ...
            Block.createCuboidShape(-2.425930000000003, 0, 1.4259299999999993, -1.4259300000000028, 15.3, 2.4259299999999993),
            ...
            Block.createCuboidShape(-1.4259300000000028, 0, 0.4259299999999975, -0.4259300000000028, 15.3, 1.4259299999999993),
            ...
            Block.createCuboidShape(-0.4259300000000028, 0, -0.5740700000000025, 0.5740700000000007, 15.3, 0.4259299999999975),
            ...
            Block.createCuboidShape(0.5740700000000007, 0, -1.5740700000000025, 1.5740700000000007, 15.3, -0.5740700000000025)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();

    private static final VoxelShape blockShape = Block.createCuboidShape(0, 0, 0, 16, 16, 16);


    public static final BooleanProperty ScannerFrameInvis = BooleanProperty.of("scanner_frame_invis");


    @Override
    public void onBreak(final World world, final BlockPos pos, final BlockState state, final PlayerEntity player) {
        super.onBreak(world, pos, state, player);
        final BlockPos masterpos = new BlockPos(pos.getX(),pos.getY() - 1, pos.getZ());
        if(world.getBlockEntity(masterpos) instanceof MasterEntity masterEntity)
        {
    ...
    public void onPlaced(final World world, final BlockPos pos, final BlockState state, @Nullable final LivingEntity placer, final ItemStack itemStack) {
        ...
        this.checkAreaNegative(world,1,2,1,pos);
    }
    ...
    public ScannerFrame(@NotNull FabricBlockSettings properties) {
        ...
        this.setDefaultState(this.getDefaultState().with(ScannerFrameInvis, false)
    ...
    protected void appendProperties(final StateManager.Builder<Block, BlockState> builder) {
        super.appendProperties(builder.add(ScannerFrameInvis).add(directionPropertyFrame));
    }
}
