...
public final class LithographyGUI extends HandledScreen<LithographyScreenHandler> {

    private static final Identifier background = CodeLyokoMain.codeLyokoPrefix("textures/gui/reactor_new.png");
    public LithographyGUI(final LithographyScreenHandler handler, final PlayerInventory inventory, final Text title) {
