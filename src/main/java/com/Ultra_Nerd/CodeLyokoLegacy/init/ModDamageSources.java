...
public record ModDamageSources() {
    //actual sources
    public  static final  DamageSource digitalOceanSource = createDamageSource("digital_ocean",DamageScaling.NEVER,0,DamageEffects.HURT,
            DeathMessageType.DEFAULT);
    public static final DamageSource marabuntaDamageSource = createDamageSource("marabunta",DamageScaling.ALWAYS,4,DamageEffects.THORNS,
            DeathMessageType.DEFAULT);
