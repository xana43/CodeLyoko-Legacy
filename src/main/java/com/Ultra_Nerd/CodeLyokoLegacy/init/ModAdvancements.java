...
public record ModAdvancements() {
    ...
    public record LyokoTierAdvancement()
    {
        ...
        {
            DISCOVERED_SUPER_COMPUTER(DiscoveredSuperCalculator),
            ENTERED_LYOKO(EnteredLyokoAdvancement);
    ...
    public record tier1Advancements()
    {
        ...
        {
            BUILD_LITHOGRAPHY_MACHINE(buildLithography);
            private final Advancement registeredAdvancement;
