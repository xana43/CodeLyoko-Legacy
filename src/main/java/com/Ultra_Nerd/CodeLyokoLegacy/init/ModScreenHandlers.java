...
public record ModScreenHandlers() {
    ...
    public static final ScreenHandlerType<ComputerControlPanelScreenHandler> CONTROL_PANEL_SCREEN_HANDLER_SCREEN_HANDLER_TYPE = new ScreenHandlerType<>((syncId, playerInventory) -> new ComputerControlPanelScreenHandler(syncId));
