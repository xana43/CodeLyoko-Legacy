package com.Ultra_Nerd.CodeLyokoLegacy.util.client.APIEmbed.impl.client.model;

import com.Ultra_Nerd.CodeLyokoLegacy.util.client.APIEmbed.impl.client.Myron;
...
public final class MyronUnbakedModel implements UnbakedModel {
    ...
    public MyronUnbakedModel(@Nullable Obj obj, @Nullable Map<String, com.Ultra_Nerd.CodeLyokoLegacy.util.client.APIEmbed.impl.client.model.MyronMaterial> materials, Collection<SpriteIdentifier> textureDependencies, SpriteIdentifier sprite, ModelTransformation modelTransformation, boolean isSideLit, boolean isBlock) {
        this.obj = obj;
