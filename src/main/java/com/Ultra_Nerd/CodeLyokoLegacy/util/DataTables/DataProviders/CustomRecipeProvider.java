...
public final class CustomRecipeProvider extends FabricRecipeProvider {
    ...
    protected void generateRecipes(final Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonBuilder.create(ModItems.TRUSTTY_SCREWDRIVER).input('i', Items.IRON_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(ModBlocks.ANODE_PART).input('c', Items.COPPER_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.INTEGRATED_HEAT_SPREADER, 20).input('i', Items.IRON_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(ModItems.KEY_CAP).input('b', ModItems.COLD_POLYCARBONATE_CONCENTRATE)
        ...
        ShapedRecipeJsonBuilder.create(ModBlocks.CATHODE_PART).input('c', Items.COPPER_INGOT)
        ...
        ShapelessRecipeJsonBuilder.create(ModItems.RAW_POLYCARBONATE).input(Items.CLAY_BALL).input(Items.BLACKSTONE)
        ...
        offerBlasting(exporter, List.of(ModItems.RAW_SILICADUST), ModItems.SILICON_WAFER, 38, 50,
                CodeLyokoMain.MOD_ID + "refinement");
        offerBlasting(exporter, List.of(ModItems.RAW_POLYCARBONATE), ModItems.MOLTEN_POLYCARBONATE_CONCENTRATE, 78, 88,
                CodeLyokoMain.MOD_ID + "refinement");
        ShapedRecipeJsonBuilder.create(ModItems.KEY_SPRING).input('i', Items.IRON_INGOT)
