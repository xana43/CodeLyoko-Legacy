...
public final class CustomRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(final Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS,ModItems.TRUSTY_SCREWDRIVER).input(Character.valueOf('i'), Items.IRON_INGOT)
                .input(Character.valueOf('h'), Items.COBWEB)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS,ModBlocks.ANODE_PART).input(Character.valueOf('c'),
                        Items.COPPER_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC,ModItems.INTEGRATED_HEAT_SPREADER, 20).input(Character.valueOf('i'),
                        Items.IRON_INGOT)
                .input(Character.valueOf('p'), Items.HEAVY_WEIGHTED_PRESSURE_PLATE)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC,ModItems.KEY_CAP).input(Character.valueOf('b'), ModItems.COLD_POLYCARBONATE_CONCENTRATE)
                .input(Character.valueOf('s'), ModItems.KEY_SPRING).criterion("knows_key", conditionsFromItem(ModItems.KEY_CAP))
                .pattern("bbb")
                .pattern("bsb")
                .pattern("sss")
                .offerTo(withConditions(exporter, NEVER_LOADED), CodeLyokoMain.codeLyokoPrefix("keycap"));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS,ModBlocks.CATHODE_PART).input(Character.valueOf('c'), Items.COPPER_INGOT)
                .input(Character.valueOf('i'), Items.IRON_INGOT).criterion("knows_cathode", conditionsFromItem(ModBlocks.CATHODE_PART))
                .pattern("cic")
                .pattern("cic")
                .pattern("cic")
        ...
        offerBlasting(exporter, List.of(ModItems.RAW_POLYCARBONATE),RecipeCategory.MISC, ModItems.MOLTEN_POLYCARBONATE_CONCENTRATE, 78, 88,
                CodeLyokoMain.codeLyokoPrefix("refinement").toString());
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC,ModItems.KEY_SPRING).input(Character.valueOf('i'), Items.IRON_INGOT)
