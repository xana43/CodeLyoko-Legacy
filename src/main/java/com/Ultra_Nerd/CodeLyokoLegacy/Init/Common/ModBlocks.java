...
public record ModBlocks() {
    ...
    static {
           ...
           LITHOGRAPHY_MACHINET2 = registerModBlocks("lithography_machine_t2", new LithographyMachineT2(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK)));
           ...
           SECTOR_ENTRANCE_DESERT = registerModBlocks("desert_sector_entrance",new SectorEntrance(FabricBlockSettings.copyOf(Blocks.BEDROCK), DimensionSelector.DESERT));
