...
public record ModBlockEntities() {
    ...
    public static final BlockEntityType<RackChargerEntity> RACK_CHARGER_BLOCK_ENTITY;
    ...
    static {
        ...
        LITHOGRAPHY_BLOCK_ENTITY_TYPE_T2 = registerModBlockEntity("lithography_block_entity_t2",BlockEntityType.Builder.create(LithographyBlockEntityInventoryT2::new,ModBlocks.LITHOGRAPHY_MACHINET2));
        UNIVERSAL_ENERGY_STORAGE = registerModBlockEntity("universal_energy_block_entity", BlockEntityType.Builder.create(
                UniversalEnergyStorageTileEntity::new, ModBlocks.STORAGE));
        TOWER_INTERFACE_TILE_ENTITY = registerModBlockEntity("tower_interface_block_entity", BlockEntityType.Builder.create(
                TowerInterfaceTileEntity::new, ModBlocks.TOWER_INTERFACE));
        SCANNER_TILE_ENTITY = registerModBlockEntity("scanner_block_entity", BlockEntityType.Builder.create(
                ScannerTileEntity::new, ModBlocks.SCANNER_BASE));
        COMPUTER_CONTROL_PANEL = registerModBlockEntity("computer_control_panel_block_entity", BlockEntityType.Builder.create(
                ComputerControlPanelTileEntity::new, ModBlocks.COMPUTER_TOWER_CONTROL_PANEL));
        COMPUTER_REACTOR_TILE_ENTITY = registerModBlockEntity("computer_integrated_reactor_block_entity", BlockEntityType.Builder.create(
        ...
        HOLOGRAM_PROJECTOR_TILE_ENTITY_BLOCK_ENTITY_TYPE = registerModBlockEntity("hologram_projector_block_entity", BlockEntityType.Builder.create(HologramProjectorTileEntity::new, ModBlocks.HOLOPROJECTOR));
        PLAYER_DATA_STORAGE_BLOCK_ENTITY_TYPE = registerModBlockEntity("player_data_test_block_entity", BlockEntityType.Builder.create(PlayerDataStorage::new, ModBlocks.TEST_PROFILE));
        VEHICLE_BE_BLOCK_ENTITY_TYPE = registerModBlockEntity("vehicle_matter_test_block_entity", BlockEntityType.Builder.create(VehicleBE::new, ModBlocks.TEST_VEHICLE_INTERFACE));
        COMPUTER_CIRCULATOR_BLOCK_ENTITY_TYPE = registerModBlockEntity("computer_circulator_block_entity",BlockEntityType.Builder.create(ComputerCirculatorBlockEntity::new,
                ModBlocks.COMPUTER_LIQUID_CIRCULATOR));
        CIRCULATOR_PIPE_BLOCK_ENTITY_TYPE = registerModBlockEntity("computer_circulator_pipe_block_entity",BlockEntityType.Builder.create(CirculatorPipeBlockEntity::new, ModBlocks.COMPUTER_LIQUID_PIPE));
        COMPUTER_FLUID_INTAKE_BLOCK_ENTITY = registerModBlockEntity("computer_fluid_intake_block_entity",BlockEntityType.Builder.create(ComputerFluidIntakeBlockEntity::new,
                ModBlocks.COMPUTER_LIQUID_INTAKE_PUMP));
        COOLER_BLOCK_ENTITY_TYPE = registerModBlockEntity("computer_fluid_cooler_block_entity",BlockEntityType.Builder.create(ComputerFluidCoolerBlockEntity::new, ModBlocks.COMPUTER_FLUID_COOLER));
        ITEM_PROJECTOR_TEST_BLOCK_ENTITY = registerModBlockEntity("test_item_projector_block_entity",BlockEntityType.Builder.create(ItemProjectorTestEntity::new, ModBlocks.TEST_ITEM_PROJECTOR));
        RACK_CHARGER_BLOCK_ENTITY = registerModBlockEntity("rack_charger_block_entity",BlockEntityType.Builder.create(RackChargerEntity::new,
    ...
    private static <T extends BlockEntity> BlockEntityType<T> registerModBlockEntity(final String name, final BlockEntityType.Builder<T> builder) {
