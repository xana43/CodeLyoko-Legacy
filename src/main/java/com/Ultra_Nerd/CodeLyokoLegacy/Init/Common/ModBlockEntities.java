...
public record ModBlockEntities() {
    ...
    public static final BlockEntityType<SuperComputerCoreBlockEntity> SUPERCOMPUTER_CORE_BLOCK_ENTITY_TYPE;



    static {

        LAPTOP_BLOCK_ENTITY = registerModBlockEntity("laptop_block_entity",FabricBlockEntityTypeBuilder.create(LaptopBlockEntity::new,ModBlocks.LAPTOP_BLOCK));
        ...
        ITEM_PROJECTOR_TEST_BLOCK_ENTITY = registerModBlockEntity("test_item_projector_block_entity",FabricBlockEntityTypeBuilder.create(ItemProjectorTestEntity::new, ModBlocks.TEST_ITEM_PROJECTOR));
        RACK_CHARGER_BLOCK_ENTITY = registerModBlockEntity("rack_charger_block_entity",FabricBlockEntityTypeBuilder.create(RackChargerEntity::new,
        ...
        SUPERCOMPUTER_CORE_BLOCK_ENTITY_TYPE = registerModBlockEntity("super_computer_blick_entity",FabricBlockEntityTypeBuilder.create(SuperComputerCoreBlockEntity::new,ModBlocks.COMPUTER_CORE));
    }
