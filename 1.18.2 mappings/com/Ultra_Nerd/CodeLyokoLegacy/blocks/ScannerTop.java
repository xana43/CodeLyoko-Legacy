...
public final class ScannerTop extends Block implements MultiBlockPartCallback {
    ...
    public static final BooleanProperty scannerFormedTop = BooleanProperty.of("scanner_formed_top");
    private static final VoxelShape shapeS = Stream.of(
            ...
            Block.createCuboidShape(13, 1, -3, 14, 14.25, -2),
            Block.createCuboidShape(2, 0, 18, 5, 15.3, 19),
            Block.createCuboidShape(2, 1, -3, 3, 14.25, -2),
            ...
            Block.createCuboidShape(18, 14.25, 5, 19, 15.25, 11),
            Block.createCuboidShape(17, 14.25, 2, 18, 15.25, 14),
            Block.createCuboidShape(16, 14.25, 1, 17, 15.25, 15),
            Block.createCuboidShape(15, 14.25, 0, 16, 15.25, 16),
            Block.createCuboidShape(14, 14.25, -1, 15, 15.25, 17),
            Block.createCuboidShape(2, 14.25, -2, 14, 15.25, 18),
            Block.createCuboidShape(5, 14.25, 18, 11, 15.25, 19),
            Block.createCuboidShape(1, 14.25, -1, 2, 15.25, 17),
            Block.createCuboidShape(0, 14.25, 0, 1, 15.25, 16),
            Block.createCuboidShape(-2, 14.25, 2, -1, 15.25, 14),
            Block.createCuboidShape(-1, 14.25, 1, 0, 15.25, 15),
            Block.createCuboidShape(5, 14.25, -3, 11, 15.25, -2),
            Block.createCuboidShape(-3, 14.25, 5, -2, 15.25, 11),
            Block.createCuboidShape(11, 14.25, -3, 14, 15.25, -2),
    ...
    private static final VoxelShape shapeN = Stream.of(
            ...
            Block.createCuboidShape(1.9999999999999991, 1, 17.547620000000002, 2.999999999999999, 14.25, 18.547620000000002),
            ...
            Block.createCuboidShape(1.9999999999999991, 0, -3.452379999999999, 4.999999999999999, 15.3, -2.452379999999999),
            ...
            Block.createCuboidShape(0.9999999999999991, 0, 16.547620000000002, 1.9999999999999991, 15.3, 17.547620000000002),
            ...
            Block.createCuboidShape(0.9999999999999991, 0, -2.452379999999999, 1.9999999999999991, 15.3, -1.452379999999999),
            ...
            Block.createCuboidShape(0.9999999999999991, 14.25, -1.452379999999999, 1.9999999999999991, 15.25, 16.547620000000002),
            ...
            Block.createCuboidShape(1.9999999999999991, 14.25, 17.547620000000002, 4.999999999999999, 15.25, 18.547620000000002),
    ...
    private static final VoxelShape shapeW = Stream.of(
            ...
            Block.createCuboidShape(-3.226189999999999, 0, 10.773810000000001, -2.226189999999999, 15.3, 13.773810000000001),
            ...
            Block.createCuboidShape(-1.226189999999999, 0, -0.2261899999999999, -0.226189999999999, 15.3, 0.7738100000000001),
            ...
            Block.createCuboidShape(-1.226189999999999, 0, 14.773810000000001, -0.226189999999999, 15.3, 15.773810000000001),
            ...
            Block.createCuboidShape(-2.226189999999999, 0, 13.773810000000001, -1.226189999999999, 15.3, 14.773810000000001),
            ...
            Block.createCuboidShape(-0.226189999999999, 14.25, 14.773810000000001, 15.773810000000001, 15.25, 15.773810000000001),
            ...
            Block.createCuboidShape(-0.226189999999999, 14.25, -0.2261899999999999, 15.773810000000001, 15.25, 0.7738100000000001),
            Block.createCuboidShape(1.77381, 14.25, -2.22619, 13.773810000000001, 15.25, -1.22619),
            Block.createCuboidShape(0.7738100000000001, 14.25, -1.22619, 14.773810000000001, 15.25, -0.2261899999999999),
    ...
    private static final VoxelShape shapeE = Stream.of(
            ...
            Block.createCuboidShape(-2.773810000000001, 1, 1.7738099999999992, -1.773810000000001, 14.25, 2.773809999999999),
            Block.createCuboidShape(18.22619, 0, 10.773810000000001, 19.22619, 15.3, 13.773810000000001),
            Block.createCuboidShape(-2.773810000000001, 1, 12.773810000000001, -1.773810000000001, 14.25, 13.773810000000001),
            ...
            Block.createCuboidShape(-1.773810000000001, 0, 0.7738099999999992, -0.773810000000001, 15.3, 1.7738099999999992),
            ...
            Block.createCuboidShape(-0.773810000000001, 0, -0.2261899999999999, 0.22618999999999811, 15.3, 0.7738099999999992),
            Block.createCuboidShape(-0.773810000000001, 0, 14.773810000000001, 0.22618999999999811, 15.3, 15.773810000000001),
            ...
            Block.createCuboidShape(-1.773810000000001, 0, 13.773810000000001, -0.773810000000001, 15.3, 14.773810000000001),
            ...
            Block.createCuboidShape(1.2261899999999981, 14.25, -1.22619, 15.226189999999999, 15.25, -0.2261899999999999),
            Block.createCuboidShape(0.22618999999999811, 14.25, -0.2261899999999999, 16.22619, 15.25, 0.7738099999999992),
            ...
            Block.createCuboidShape(0.22618999999999811, 14.25, 14.773810000000001, 16.22619, 15.25, 15.773810000000001),
            ...
            Block.createCuboidShape(-2.773810000000001, 14.25, 4.773809999999999, -1.773810000000001, 15.25, 10.773810000000001),
            Block.createCuboidShape(5.226189999999998, 14.25, 17.77381, 11.226189999999999, 15.25, 18.77381),
            Block.createCuboidShape(-2.773810000000001, 14.25, 1.7738099999999992, -1.773810000000001, 15.25, 4.773809999999999),
            Block.createCuboidShape(-2.773810000000001, 14.25, 10.773810000000001, -1.773810000000001, 15.25, 13.773810000000001)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
    ...
    public void onPlaced(final World world, final BlockPos pos, final BlockState state, @Nullable final LivingEntity placer, final ItemStack itemStack) {
        ...
        this.checkAreaNegative(world,1,3,1,pos);
    }
    ...
    protected void appendProperties(final StateManager.Builder<Block, BlockState> builder) {
        super.appendProperties(builder.add(directionPropertyTop).add(scannerFormedTop));
    }
