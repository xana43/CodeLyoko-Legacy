package com.Ultra_Nerd.CodeLyokoLegacy.Entity.model;// Made with Blockbench 4.2.4
...
public final class ModelOverboard<T extends OverboardEntity> extends EntityModel<T> {
	...
	public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(CodeLyokoMain.CodeLyokoPrefix("overboard"), "main");
	...
	public static TexturedModelData createBodyLayer() {
		...
		final ModelPartData partdefinition = meshdefinition.getRoot();
		 ...
		 final ModelPartData MainBody = partdefinition.addChild("Mainbody", ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -1.0F, -4.0F, 6.0F, 1.0F, 9.0F, new Dilation(0.0F))
		...
		.uv(0, 7).mirrored().cuboid(-6.0F, -4.0F, -4.0F, 2.0F, 1.0F, 12.0F, new Dilation(0.0F)).mirrored(false)
		...
		.uv(0, 20).mirrored().cuboid(-9.0F, -4.0F, -3.0F, 3.0F, 1.0F, 7.0F, new Dilation(0.0F)).mirrored(false)
		...
		.uv(0, 9).mirrored().cuboid(-4.0F, -4.0F, 2.0F, 8.0F, 1.0F, 4.0F, new Dilation(0.0F)).mirrored(false)
		.uv(0, 13).mirrored().cuboid(-4.0F, -4.0F, -2.0F, 8.0F, 1.0F, 4.0F, new Dilation(0.0F)).mirrored(false)
		...
		.uv(0, 0).cuboid(-4.0F, -4.0F, -4.0F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
